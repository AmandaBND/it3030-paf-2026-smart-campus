...
public class QrService {
	...
	public boolean verifySignature(Long bookingId, String signatureHex) {
	...
	private String sign(Long bookingId) {
		try {
			Mac mac = Mac.getInstance("HmacSHA256");
			mac.init(new SecretKeySpec(hmacKey, "HmacSHA256"));
			byte[] raw = mac.doFinal(String.valueOf(bookingId).getBytes(StandardCharsets.UTF_8));
